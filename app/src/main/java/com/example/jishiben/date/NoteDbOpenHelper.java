package com.example.jishiben.date;
...
//    private SQLiteHelper mHelper;
    ...
    private static final String CRETE_TABLE_SQL = "create table " + TABLE_NAME_NOTE + " (id integer primary key autoincrement, title text,content text,create_time text)";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(CRETE_TABLE_SQL);
//        db.execSQL("delete from note", new Object[]{});
//        mHelper = new SQLiteHelper(this);
//        SQLiteDatabase db = mHelper.getReadableDatabase();
//        db.execSQL("delete from sporttable");
